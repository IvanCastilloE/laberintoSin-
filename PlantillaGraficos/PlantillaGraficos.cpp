...
//Las colisiones
void colisiones() {
	if (posXTriangulo + 0.15f >= posXCuadrado - 0.15f &&
		posYTriangulo + 0.15f >= posYCuadrado - 0.15f &&
		posXTriangulo - 0.15f <= posXCuadrado + 0.15f &&
		posYTriangulo - 0.15f <= posYCuadrado + 0.15f) {
		exit(1);
	}
	else if (posXTriangulo + 0.15f >= posXCuadrado2 - 0.15f &&
		posYTriangulo + 0.15f >= posYCuadrado2 - 0.15f &&
		posXTriangulo - 0.15f <= posXCuadrado2 + 0.15f &&
		posYTriangulo - 0.15f <= posYCuadrado2 + 0.15f) {
		exit(1)
	}
	else if (posXTriangulo + 0.15f >= posXCuadrado3 - 0.15f &&
		posYTriangulo + 0.15f >= posYCuadrado3 - 0.15f &&
		posXTriangulo - 0.15f <= posXCuadrado3 + 0.15f &&
		posYTriangulo - 0.15f <= posYCuadrado3 + 0.15f) {
		exit(1)
	}
	else if (posXTriangulo + 0.15f >= posXCuadrado4 - 0.15f &&
		posYTriangulo + 0.15f >= posYCuadrado4 - 0.15f &&
		posXTriangulo - 0.15f <= posXCuadrado4 + 0.15f &&
		posYTriangulo - 0.15f <= posYCuadrado4 + 0.15f) {
		exit(1)
	}
	else if (posXTriangulo + 0.15f >= posXrec - 0.15f &&
		posYTriangulo + 0.15f >= posYrec - 0.15f &&
		posXTriangulo - 0.15f <= posXrec + 0.15f &&
		posYTriangulo - 0.15f <= posYrec + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec2 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec2 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec2 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec2 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec3 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec3 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec3 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec3 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec4 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec4 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec4 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec4 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec5 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec5 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec5 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec5 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec6 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec6 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec6 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec6 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec7 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec7 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec7 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec7 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec8 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec8 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec8 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec8 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec9 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec9 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec9 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec9 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec10 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec10 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec10 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec10+ 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec11 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec11 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec11 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec11 + 0.15f) {
		exit(1)
	}
	else if (
		posXTriangulo + 0.15f >= posXrec12 - 0.15f &&
		posYTriangulo + 0.15f >= posYrec12 - 0.15f &&
		posXTriangulo - 0.15f <= posXrec12 + 0.15f &&
		posYTriangulo - 0.15f <= posYrec12 + 0.15f) {
		exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec13 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec13 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec13 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec13 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec14 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec14 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec14 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec14 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec15 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec15 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec15 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec15 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec16 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec16 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec16 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec16 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec17 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec17 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec17 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec17 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec18 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec18 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec18 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec18 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec19 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec19 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec19 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec19 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec20 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec20 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec20 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec20 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec21 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec21 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec21 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec21 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec22 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec22 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec22 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec22 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec23 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec23 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec23 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec23 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec24 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec24 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec24 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec24 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec25 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec25 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec25 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec25 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec26 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec26 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec26 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec26 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec27 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec27 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec27 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec27 + 0.15f) {
	exit(1)
	}
	else if (
	posXTriangulo + 0.15f >= posXrec28 - 0.15f &&
	posYTriangulo + 0.15f >= posYrec28 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec28 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec28 + 0.15f) {
	exit(1)
	}
	...
	posYTriangulo + 0.15f >= posYrec29 - 0.15f &&
	posXTriangulo - 0.15f <= posXrec29 + 0.15f &&
	posYTriangulo - 0.15f <= posYrec29 + 0.15f) {
	exit(1)
	}
